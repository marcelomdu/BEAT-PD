...
def train_model2(train_inputs, test_inputs, train_labels, test_labels):
  epochs = 5
  batch_size = 16
  vocab = 5
...
for subject in subjects_list:
    ...
    train_inputs, test_inputs, train_labels, test_labels = train_test_split(train_features, train_labels, train_size=0.8, random_state=42)

    results = train_model2(train_inputs, test_inputs, train_labels, test_labels)
